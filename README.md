...
[![Docker image](https://img.shields.io/badge/docker%20image-~300%20MB-2496ed?logo=docker&logoColor=white)](https://ghcr.io/slashgear/gdpr-cookie-scanner)
...
> [!NOTE]
> The image is ~300 MB compressed (~750 MB unpacked). This is inherent to shipping a full Chromium
